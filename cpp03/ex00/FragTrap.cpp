...
{
	std::cout << "Booting sequence complete. Hello! I am your new FR4G-TP assault bot." << std::endl;
}
...
void		FragTrap::takeDamage(unsigned int amount)
{
	...
	if (amount - (unsigned)this->_armor < (unsigned)this->_hp)
		...
		this->_hp = 0;
	std::cout << "<FR4G-TP " << this->_name << "> My robotic flesh! AAHH!" << std::endl;
}
...
void		FragTrap::beRepaired(unsigned int amount)
{
	...
	{
		this->_hp += amount;
		std::cout << "<FR4G-TP " << this->_name << "> Back for more!" << std::endl;
	}
	else
	{
		this->_hp = this->_max_hp;
		std::cout << "<FR4G-TP " << this->_name << "> Like new, let's get'em!" << std::endl;
	}
}
...
void		FragTrap::vaulthunter_dot_exe(const std::string& target)
{
	...
	(void)target;
	if (this->_ep - 25 < 0)
		std::cout << "<FR4G-TP " << this->_name << "> Coming up empty!" << std::endl;
	else
	{
		this->_ep -= 25;
		std::cout << "<FR4G-TP " << this->_name << "> " << launch_quotes[std::rand() % 6] << std::endl;
		std::cout << "FR4G-TP " << this->_name << attacks[std::rand() % 5] << std::endl;
		std::cout << "<FR4G-TP " << this->_name << "> " << attack_quotes[std::rand() % 5] << std::endl;
	}
